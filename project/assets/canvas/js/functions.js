	...
	SEMICOLON.header = {
		...
		superfish: function(){
			...
			if ( $().superfish ) {
				...
				$('body:not(.side-header) #primary-menu > ul, body:not(.side-header) #primary-menu > div > ul, .top-links > ul, #top-cart-trigger').superfish({
					popUpSelector: 'ul,.mega-menu-content,.top-link-section, .top-cart-content',
					delay: 250,
					speed: 350,
